 ...
 *
 * <p>This encapsulates a partner/internal REST API that has no public SDK. The real implementation
 * ({@link HttpInventoryClient}) handles HTTP concerns. In tests, an in-memory implementation
 * records calls without any HTTP.
 */
public interface InventoryClient {

  /**
   * Reserve inventory for an order. The inventory service holds the items until the order ships or
