 ...
 *
 * Stores and retrieves documents from S3. In tests, the injected {@link S3Client}
 * is a test implementation that stores objects in-memory and validates bucket names.
 */
@Component
