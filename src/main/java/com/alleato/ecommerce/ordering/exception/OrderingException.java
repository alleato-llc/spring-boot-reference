 ...
 *
 * <p>Carries a message (via super) and an optional context map for structured error details.
 * Subclasses represent specific failure categories — {@code @ControllerAdvice} maps each subclass
