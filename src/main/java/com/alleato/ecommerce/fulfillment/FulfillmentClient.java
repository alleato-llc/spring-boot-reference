...
/**
 * Contract for enqueuing order fulfillment jobs. When an order is confirmed, a fulfillment message
 * is sent to a queue for async processing (picking, packing, shipping).
 *
 * <p>Real implementation uses AWS SQS. Test implementation captures enqueued messages for
 * assertion.
 */
