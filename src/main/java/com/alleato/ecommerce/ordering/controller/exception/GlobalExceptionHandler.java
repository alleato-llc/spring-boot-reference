...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInternalServer(OrderingInternalServerException ex) {
        ...
        var body = new ErrorResponse("An internal error occurred", HttpStatus.INTERNAL_SERVER_ERROR.value(), Map.of());
    ...
    public ResponseEntity<ValidationErrorResponse> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        var body = new ValidationErrorResponse("Validation failed", HttpStatus.BAD_REQUEST.value(), fieldErrors);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(body);
    }
