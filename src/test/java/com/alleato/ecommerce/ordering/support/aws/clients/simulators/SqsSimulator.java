...
/**
 * Simulates an SQS service for integration tests. Produces a mock {@link SqsClient}
 * that validates queue URLs, records sent messages, and supports configurable failures.
 *
 * <p>This is a stateless simulator — messages are fire-and-forget. The domain API
 * ({@link #getMessages()}, {@link #findMessage(Predicate)}) is the complete history.
 *
 * <p>Usage:
 * <pre>{@code
...
public class SqsSimulator {
    ...
    /**
     * Returns the simulated {@link SqsClient}. Always returns the same instance.
