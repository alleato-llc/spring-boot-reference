...
/**
 * Simulates an SNS service for integration tests. Produces a mock {@link SnsClient} that validates
 * topic ARNs, records published messages, and supports configurable failures.
 *
 * <p>This is a stateless simulator — publications are fire-and-forget. The domain API ({@link
 * #getPublications()}, {@link #findPublication(Predicate)}) is the complete history.
 *
 * <p>Usage:
 *
 * <pre>{@code
...
public class SnsSimulator {
  ...
  /**
   * Returns the simulated {@link SnsClient}. Always returns the same instance. Register this as a
