 ...
 *
 * Methods without an {@link HttpStatus} parameter assert the expected default
 * status (201 for create, 200 for get). Use the overloaded variant to assert
 * a different status.
 *
 * On error status codes, throws {@link ApiException} with the status and
 * response body for test assertion.
 */
public class OrderClient {
     ...
     * Carries the HTTP status and response body for test assertion.
     */
