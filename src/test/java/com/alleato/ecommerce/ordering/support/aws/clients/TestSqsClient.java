...
/**
 * Test implementation of the AWS SQS client. Instead of calling real SQS, it:
 *  - Validates that the queue URL is one of the known/configured queues
 *  - Records all SendMessage calls for test assertion
 *  - Returns realistic responses
 *  - Throws realistic errors for unknown queues
 *  - Supports configurable exception rules to simulate runtime failures
 *
 * This allows integration tests to use the real {@link com.alleato.ecommerce.ordering.fulfillment.SqsFulfillmentClient}
...
public class TestSqsClient implements SqsClient {
     ...
     * Useful for simulating SQS outages, throttling, or other runtime failures.
     *
