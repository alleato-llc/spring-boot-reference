...
/**
 * Simulates an S3 service for integration tests. Produces a mock {@link S3Client}
 * that validates buckets, stores objects in memory, and supports configurable failures.
 *
 * <p>This is a stateful simulator. The primary API reflects the current state of the
 * simulated store ({@link #findObject}, {@link #hasObject}). A unified request log
 * preserves full SDK metadata for all operations.
 *
 * <p>Usage:
 * <pre>{@code
...
public class S3Simulator {
    ...
    /**
     * Returns the simulated {@link S3Client}. Always returns the same instance.
