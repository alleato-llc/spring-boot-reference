...
/**
 * Sets trace context from SQS message attributes into MDC for the duration of a task,
 * ensuring cleanup in a finally block to prevent context leaking between messages.
 */
