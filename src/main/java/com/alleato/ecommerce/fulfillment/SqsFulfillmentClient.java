 ...
 *
 * <p>Sends fulfillment messages to an SQS FIFO queue for async processing by a downstream
 * fulfillment service. In tests, the injected {@link SqsClient} is a test implementation that
 * records calls and validates queue URLs.
 */
@Component
