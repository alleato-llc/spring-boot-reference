...
/**
 * Pure business logic — no external dependencies, no mutation. Accepts line items and an optional
 * promo code, returns a PricingResult. This is the kind of component best tested with plain unit
 * tests, because the value is in verifying the algorithm, not the wiring.
 */
@Service
